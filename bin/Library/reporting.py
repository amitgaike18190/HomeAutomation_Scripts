...
class Report(unittest.TestCase):
    ...
    def capture_log(self,session_name, cmd, cmdtype):
        ...
        #errors = False
        if cmdtype == "cmd":
            outfile = str(session_name)
            errfile = "err_" + str(session_name)
        elif cmdtype == "ssh":
            outfile = "sshout_" + str(session_name)
            errfile = "ssherr_" + str(session_name)
    ...
    def open_cmd(self,session_name, descr):
        ...
        try:
            ...
            with open("err_" + str(session_name), "w+") as f:
    ...
    def open_ssh(self,session_name, desc):
        ...
        try:
            print("ssh here")
            logging.debug('Active threads are: %s', threading.enumerate())
            abc = [r"C:\Program Files (x86)\PuTTY\plink.exe", "-ssh", "pi@192.168.1.245", "-pw", "raspberry"]
            ...
            with open("ssherr_" + str(session_name), "w+") as f:
                f.write(err.decode('utf-8'))
            with open("sshout_" + str(session_name), "w+") as f:
                f.write(output.decode('utf-8'))
