...
class cpaas_pyTest(unittest.TestCase):
    ...
    def testscript(self):
        ...
        xpaths = { 	
                    ...
                    'reportdownlod' : '//body/div[3]/div[3]/div[2]/table/tbody/tr/td[4]'
        ...
        autoit.win_wait_active("Open", 25)
        path = r"C:\Users\deepthi.a.desai\.jenkins\jobs\POTABuildDeployTest\workspace\Library\TempHumid.py"
        print(path)
        time.sleep(2)
        ...
        time.sleep(2)
        print('Probe',str(g), 'uploaded successfully')
        ...
        with open(path,"r") as f:
            for line in f:
                print(line)
                hum,temp = (line.split(",")[1]).strip(),((line.split(",")[4])[0:3]).strip()
                break
                
        
        print("hum,temp",hum,temp)
        # Remove report
        #os.chdir(r'C:\Users\%s\Downloads')
        os.remove(path)
        
        file1 = r"/home/pi/Desktop/POTA/WriteToPI.py"
        sshitem = "sudo python3 "+" "+file1+" "+hum+" "+temp
        abc = [r"C:\Users\deepthi.a.desai\Desktop\Backup\EclipseMars\Putty\PLINK.EXE", "-ssh", "pi@192.168.0.2", "-pw", "raspberry"]
